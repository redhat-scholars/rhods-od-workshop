...
image::s2i/git-repo.png[alt text, 640]
...
image::s2i/builder.png[alt text, 640]
...
image::s2i/create-app.png[alt text, 640]

== Checking your Application

* You will see that a build is going on:

image::s2i/topology.png[alt text, 640]

* Click on the deployment to open a detail panel on the right.

image::s2i/topology-rest-building.png[alt text, 640]
...
image::s2i/topology-rest-complete.png[alt text, 640]
