...
image::s2i/topology-rest-service.png[alt text, 640]
...
image::s2i/select-project.png[alt text, 480]

* From the `+Add` menu, click on the `From Git` tile:

image::s2i/from-git.png[alt text, 640]
...
image::s2i/git-repo-app.png[alt text, 640]
...
image::s2i/general-app.png[alt text, 640]
...
image::s2i/create-app-route.png[alt text, 640]
...
image::s2i/create-app-route-adv.png[alt text, 640]
...
image::s2i/create-app-deployment.png[alt text, 640]
...
image::s2i/create-app-env-var.png[alt text, 640]
...
image::s2i/topology-app.png[alt text, 640]
...
image::s2i/app-screenshot.png[alt text, 640]
