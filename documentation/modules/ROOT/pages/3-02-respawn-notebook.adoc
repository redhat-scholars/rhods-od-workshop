...
image::kafka/notebook-hub.png[alt text, 640]

* Click the *Stop My Server* Button

image::kafka/notebook-spawn-stop.png[alt text, 640]

* Wait for the Stop My Server button to disappear and then click the *Start My Server* Button

image::kafka/notebook-spawn-start.png[alt text, 640]
...
This will start your noteook server and now you're ready to xref:3-03-explore-kafka.adoc[head to the next section.]
