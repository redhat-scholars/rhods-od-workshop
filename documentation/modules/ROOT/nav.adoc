...
** xref:3-03-explore-kafka.adoc[2. Explore Kafka in a Notebook]
** xref:3-04-create-secret.adoc[3. Create a Secret to Connect]
** xref:3-05-kakfa-consumer.adoc[4. Deploy a Kafka Consumer]
